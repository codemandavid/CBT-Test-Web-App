...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-bottom:30px;">
     ...
     <div class="row">
          <div class="col-lg-12">
            <h2 id="type-blockquotes">Contact Us</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
            <blockquote>
              <p>Email:&nbsp;&nbsp;&nbsp;&nbsp;bjaypjay2012@gmail.com</p>
			  <small>You can email us<cite title="Source Title"></cite></small>
			  <p>Phone Number:&nbsp;&nbsp;&nbsp;&nbsp;+2348169013692</p>
              <small>You can call us<cite title="Source Title"></cite></small>
			  <p>Department:&nbsp;&nbsp;&nbsp;&nbsp;Computer Engineering</p>
              <small>You can call get us<cite title="Source Title"></cite></small>
			  <p>School Address:&nbsp;&nbsp;&nbsp;&nbsp;Hall residence number</p>
              <small>You can check us<cite title="Source Title"></cite></small>
			  <p>Home Address:&nbsp;&nbsp;&nbsp;&nbsp;Alakia, Ibadan</p>
              <small>You can check us<cite title="Source Title"></cite></small>
